...
if GAME_TYPE == 'simple':
    env = SimpleGame(TEST_REWARD_PATH, TEST_STATE_PATH, TEST_EPISODE_PATH)
    OUTPUTS = [REWARD_LIST, ACTION_LIST, STATE_LIST]
    to_output = ['', '', '']

elif GAME_TYPE == 'movement':
    env = MovementGame(TEST_REWARD_PATH, TEST_STATE_PATH, TEST_EPISODE_PATH, TEST_LOCATION_PATH, TEST_TRANSITION_PATH, STIMULUS_REPS)
    ...
    env = ConvMovementGame(TEST_REWARD_PATH, TEST_STATE_PATH, TEST_EPISODE_PATH, TEST_LOCATION_PATH, TEST_TRANSITION_PATH, MOVE_SEPERATION, WAITTIME, GAME_MODE, CONV_SIZE, STIMULUS_REPS)
    LOCATION_LIST = ROOT + LOCATION_LIST_FILE + '_' + MODELNAME + '.txt'
    OUTPUTS = [REWARD_LIST, ACTION_LIST, STATE_LIST, LOCATION_LIST,]
    to_output = ['', '', '', '']
