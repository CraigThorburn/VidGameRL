...
if GAME_TYPE == 'convmovement':
    env = AcousticsGame2DConvFromFile(ROOT + 'test_'+REWARD_FILE + '.txt', ROOT +'test_' + STATE_FILE + '.txt', ROOT +'test_'+EPISODE_FILE + '.txt', ROOT +LOCATION_FILE + '.txt', ROOT +TRANSITION_FILE + '.txt',  ROOT +  GAME_WAVS_FOLDER, MOVE_SEPERATION, WAITTIME, GAME_MODE, STIMULUS_REPS, device)
