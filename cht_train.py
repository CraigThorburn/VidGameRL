...
if GAME_TYPE == 'cht':
    env = AcousticsGame2DConvCHT(ROOT + REWARD_FILE + '.txt', ROOT +STATE_FILE + '.txt', ROOT +EPISODE_FILE + '.txt', ROOT +LOCATION_FILE + '.txt', ROOT +TRANSITION_FILE + '.txt',  ROOT +  GAME_WAVS_FOLDER,MOVE_SEPERATION, WAITTIME, GAME_MODE, STIMULUS_REPS, device, CHANGE_TRIAL)
