...
$train_cmd --mem 16GB JOB=1:$num_runs --gpu $gpu ../../data/$data_folder/log/$experiment_name/acousticgame_pretrain_validation.$model_id.JOB.log  run_python.sh acousticgame_pretrain_validation.py $params || exit 1;
...
$train_cmd --mem 16GB JOB=1:$num_runs --gpu $gpu ../../data/$data_folder/log/$experiment_name/acousticgame_train.$model_id.JOB.log  run_python.sh acousticgame_train.py $params || exit 1;
...
if [ $stage -le 5 ]; then
echo "starting trainign results processing"
