...
def generate_log_table(node, port, experiment_folder):
    ...
    stage_names = ['acousticgame_pretrain_network', 'acousticgame_pretrain_validation', 'acousticgame_calculate_ewc_coeffs', 
                   ...
                   'acousticgame_train_validation', 'acousticgame_create_h5features']#test-1         
    log_outcomes = {}
    unix_codes = []
    for exp in experiments:
        ...
        for l in logfiles_names:
            ...
            if unix_code not in unix_codes:
                log_outcomes[unix_code] = {(experiment_folder, exp, model, run): [None, None, None, None, None, None, None, None, None, None, None]}
  ...
  #      print(log_outcomes[d])
    ...
    html_firstrow = '<tr>    <td class="tg-0lax">Experiment</td><td class="tg-0lax">Date/Time</td>    <td class="tg-0lax">ID</td>    <td class="tg-0lax">Run</td>    <td class="tg-0lax">Pretraining</td>    <td class="tg-0lax">Validation</td>    <td class="tg-0lax">Fischer Coefficients</td>    <td class="tg-0lax">Pretrain ABX</td>    <td class="tg-0lax">Training</td>    <td class="tg-0lax">Results Processing</td>    <td class="tg-0lax">Train ABX</td>  <td class="tg-0lax">Unused</td> <td class="tg-0lax">Unused</td> <td class="tg-0lax">Train Validation</td> <td class="tg-0lax">Train h5features</td> </tr>'
    html_suffix = '</tbody>\n</table>'
