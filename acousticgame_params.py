### FILE VARIABLES
PRETRAIN_MODELNAME_ADITIONS = 'pretraining_ewcbatch200' #extra suffix for the pretraining folder
TRAIN_MODELNAME_ADITIONS = 'ewcbatch200_trainWSJ_EWC0.01_750eps' #extra suffix for the training folder
### General
